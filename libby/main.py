...
STYLE["width"] = 1345 #  width = 300 (default)
STYLE["heigth"] = '500px' # min-height = "300px"
...
botao_livro= Elemento(LIVRO, tit="título_do_elemento",
                           style=dict(height=200,widht=233, left=480, top=300), # ou x=eixo_x, y=eixo_y, w=largura, h=altura
                           cena = cena1,
