...
ramo_nivel_tres_um    = Elemento(BRACO_UM_UM                , x =561, y=892, w=81 , h=100, cena = fundo_estatico)
ramo_nivel_tres_dois  = Elemento(BRACO_UM_DOIS              , x =478, y=928, w=52 , h=93 , cena = fundo_estatico)
ramo_nivel_tres_dois  = Elemento(BRACO_UM_TRES              , x =359, y=873, w=98 , h=85 , cena = fundo_estatico)

criterio_cor_vermelho = Elemento(CRITERIO_COR_VERMELHO      , x =490, y=805, w=52 , h=52 , cena = fundo_estatico)
