...
IndentationError: unexpected indent
'''},
{'date': 'Mon Sep 14 2020 21:21:37.76 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 27
  )
  ^
IndentationError: unexpected indent
'''},
{'date': 'Mon Sep 21 2020 19:28:46.265 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 26
    cenaFloresta.direita = CenaFloresta
NameError: name 'CenaFloresta' is not defined
'''},
{'date': 'Mon Sep 21 2020 19:31:06.94 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
NameError: name 'cenaBorboleta' is not defined
'''},
{'date': 'Mon Sep 21 2020 19:31:23.161 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
NameError: name 'cenaBorboleta' is not defined
'''},
{'date': 'Mon Sep 21 2020 19:33:31.78 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
'''},
{'date': 'Mon Sep 21 2020 19:33:50.333 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module _core.supygirls_factory line 299
    exec(self.code, glob)  # dict(__name__="__main__"))
  module <module> line 30
    cena_esquerda.direita = cenaFloresta
NameError: name 'cena_esquerda' is not defined
'''},
{'date': 'Mon Sep 21 2020 19:34:04.413 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
NameError: name 'cena_esquerda' is not defined
'''},
{'date': 'Mon Sep 28 2020 20:05:05.396 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 180
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
